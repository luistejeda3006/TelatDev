...
export default ({handlePress = () => {}, children}) => {
    ...
    return(
        <View style={tw`bg-[#fff] flex-1 justify-center items-center`}>
            ...
            <View style={tw`h-15 self-stretch justify-center items-end px-6 border-b border-b-[#dadada] bg-[#fff] mb-6`}>
                {
                    !error
                    ?
                        <TouchableOpacity style={tw`w-auto h-auto bg-[${Blue}] justify-center items-center rounded-2xl px-3 py-2`} onPress={() => handlePress()}>
