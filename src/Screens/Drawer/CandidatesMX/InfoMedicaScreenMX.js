    ...
    return (
        <>
            ...
            <SafeAreaView style={{ flex: 0, backgroundColor: SafeAreaBackground }} />
            {
                ...
                ?
                    <HeaderPortrait title={language === '1' ? 'Información Médica' : 'Medic Information'} screenToGoBack={'Dashboard'} navigation={navigation} visible={true} />
                :
                    <HeaderLandscape title={language === '1' ? 'Información Médica' : 'Medic Information'} screenToGoBack={'Dashboard'} navigation={navigation} visible={true} />
            }
            {
